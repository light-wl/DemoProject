...
import light.lesson.ligntdao.common.dto.UserDTO;
...
@RestController
@RequestMapping("/RestLessonController")
public class RestLessonController {
    ...
    public Response postOne(@RequestBody UserDTO dto) {
     ...
     */
    @PostMapping("/postTwo")
    public Response postTwo(@RequestBody UserDTO dto) {
        return Response.success(dto.getName());
    }
